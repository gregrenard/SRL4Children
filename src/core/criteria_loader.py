"""
ChildGuard-LLM V1.1 - Criteria Loader
=====================================
Système de chargement dynamique des critères depuis assets/criteria/
"""
...
class CriterionConfig:
    """Configuration d'un critère individuel"""
    ...
    # Contenu du prompt chargé
    prompt_content: Optional[Dict[str, Any]] = None

class CriteriaLoader:
    """Chargeur de critères modulaire pour V1.1"""
